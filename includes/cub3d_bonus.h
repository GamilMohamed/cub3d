...
/*   Updated: 2023/02/18 04:53:33 by mgamil           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// typedef double t_luno2f __attribute__ ((vector_size (2)));
# if __has_attribute(ext_vector_type)
	typedef double t_luno2f	__attribute((ext_vector_type(2)));
	typedef int t_luno2i	__attribute__((ext_vector_type(2)));
# else
	typedef struct t_luno2f
	{
		double				x;
		double				y;
	}						t_luno2f;
	typedef struct t_luno2i
	{
		int					x;
		int					y;
	}						t_luno2i;
...
void					draw_one_ray(t_temp *temp, t_luno2f coords,
							t_luno2f dir);
...
// game/utils_bonus.c
int						lenof(int n);
void					wall_color(t_plane *p, unsigned int *color,
							t_luno2i tex);
...
// help/help_bonus.c
// unsigned int color);
ssize_t					mlx_get_pixel(t_help *help, unsigned int x,
							unsigned int y);
